...
public class PermissionsUtil {
    ...
    private static String[] PERMISSIONS_GROUP = {
            Manifest.permission.READ_CONTACTS,Manifest.permission.WRITE_CALENDAR,Manifest.permission.READ_CALENDAR,
            Manifest.permission.CALL_PHONE,Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.SYSTEM_ALERT_WINDOW,
    ...
    public static void checkAndRequestPermissions(final Activity activity) {
        ...
        for (String permission : PERMISSIONS_GROUP) {
            ...
            Log.i(TAG, "checkAndRequestPermissions: "+permission+"  "+grantCode);
